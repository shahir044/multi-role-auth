<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <!-- PG NO -->
            <x-input-label for="pg_no" :value="__('PG No')" />
            <x-text-input id="pg_no" name="pg_no" type="text" class="mt-1 block w-full" :value="old('pg_no', $user->pg_no)" required  readonly/>
        ...
        <div>
            ...
            <x-text-input id="nid" name="nid" type="text" class="mt-1 block w-full" :value="old('nid', $user->nid)" required readonly/>
